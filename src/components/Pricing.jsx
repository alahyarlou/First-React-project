        ...
        <div name='pricing' className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                ...
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-3xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita ea dolorum itaque, necessitatibus temporibus debitis nobis et ratione reprehenderit laborum ullam iusto, error qui dolor.</p>
                </div>
